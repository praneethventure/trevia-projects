...
export class Backend implements backendInterface {
    ...
    async addProject(arg0: Project): Promise<ProjectId> {
        if (this.processError) {
            try {
    ...
    async deleteContactSubmission(arg0: ContactId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async editProject(arg0: ProjectId, arg1: Project): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editProject(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllContactSubmissions(): Promise<Array<[ContactId, ContactSubmission]>> {
        if (this.processError) {
            try {
    ...
    async getAllProjects(): Promise<Array<[ProjectId, Project]>> {
        if (this.processError) {
            try {

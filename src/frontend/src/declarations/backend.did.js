...
export const Project = IDL.Record({
  'title' : IDL.Text,
  'completedPercentage' : IDL.Nat,
  'forRentUnits' : IDL.Nat,
  'ongoingPercentage' : IDL.Nat,
  'imageUrl' : IDL.Text,
  'location' : IDL.Text,
  'forSaleUnits' : IDL.Nat,
});
...
export const idlService = IDL.Service({
  ...
  'addProject' : IDL.Func([Project], [ProjectId], []),
  'assignCallerUserRole' : IDL.Func([IDL.Principal, UserRole], [], []),
  'deleteContactSubmission' : IDL.Func([ContactId], [], []),
  'deleteProject' : IDL.Func([ProjectId], [], []),
  'editProject' : IDL.Func([ProjectId, Project], [], []),
  'getAllContactSubmissions' : IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(ContactId, ContactSubmission))],
      ['query'],
    ),
